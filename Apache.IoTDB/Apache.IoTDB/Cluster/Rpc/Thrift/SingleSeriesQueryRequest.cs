...
namespace Apache.IoTDB.Cluster.Rpc.Thrift
{
  ...
  public partial class SingleSeriesQueryRequest : TBase
  {
    private byte[] _timeFilterBytes;
    private byte[] _valueFilterBytes;
    ...
    public byte[] ValueFilterBytes
    {
      get
      {
        return _valueFilterBytes;
      }
      set
      {
        __isset.valueFilterBytes = true;
        this._valueFilterBytes = value;
      }
    }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.String)
              {
                ValueFilterBytes = await iprot.ReadBinaryAsync(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
            ...
            case 8:
              ...
              {
                {
                  TSet _set21 = await iprot.ReadSetBeginAsync(cancellationToken);
                  DeviceMeasurements = new THashSet<string>(_set21.Count);
                  for(int _i22 = 0; _i22 < _set21.Count; ++_i22)
                  {
                    string _elem23;
                    _elem23 = await iprot.ReadStringAsync(cancellationToken);
                    DeviceMeasurements.Add(_elem23);
                  }
    ...
    public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var struc = new TStruct("SingleSeriesQueryRequest");
        ...
        if (ValueFilterBytes != null && __isset.valueFilterBytes)
        {
          field.Name = "valueFilterBytes";
          field.Type = TType.String;
          field.ID = 3;
          await oprot.WriteFieldBeginAsync(field, cancellationToken);
          await oprot.WriteBinaryAsync(ValueFilterBytes, cancellationToken);
          await oprot.WriteFieldEndAsync(cancellationToken);
        }
        field.Name = "queryId";
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter24 in DeviceMeasurements)
          {
    ...
    {
      var other = that as SingleSeriesQueryRequest;
      ...
      return System.Object.Equals(Path, other.Path)
        ...
        && ((__isset.valueFilterBytes == other.__isset.valueFilterBytes) && ((!__isset.valueFilterBytes) || (TCollections.Equals(ValueFilterBytes, other.ValueFilterBytes))))
    ...
    public override int GetHashCode() {
      ...
      unchecked {
        ...
        if(__isset.valueFilterBytes)
          hashcode = (hashcode * 397) + ValueFilterBytes.GetHashCode();
    ...
    {
      var sb = new StringBuilder("SingleSeriesQueryRequest(");
      sb.Append(", Path: ");
      sb.Append(Path);
      if (TimeFilterBytes != null && __isset.timeFilterBytes)
      {
